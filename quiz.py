...
class Quiz:
    ...
    def buttons(self):
        ...
        quit_button = Button(gui, text="Quit", command=gui.destroy,
                             width=5, bg="black", fg="white", font=("Comic Sans MS", 16, " bold"))
    ...
    def display_question(self):
        ...
        q_no = Label(gui, text=question[self.q_no], width=60,
                     font=('Comic Sans MS', 16, 'bold'), anchor='w')
    ...
    def display_title(self):
        ...
        title = Label(gui, text="A.I QUIZ BY DEVANSH MADE WITH PYTHON",
                      width=50, bg="black", fg="white", font=("Comic Sans MS", 20, "bold"))
...
gui.title("A.I QUIZ BY DEVANSH MADE WITH PYTHON")
